...
DATASETS = {
    ...
    # Moral training datasets — generated by scripts/generate_moral_dataset.py
    # Sources: Bible, Quran, Bhagavad Gita, Tao Te Ching, Dhammapada, Stoic texts,
    #          Secular Humanism, hendrycks/ethics, demelin/moral_stories
    "moral_pretrain": DatasetConfig(
        path="./datasets/moral_pretrain",
        loader=lambda path: load_dataset(
            "json", data_files=f"{path}/data.jsonl", split="train"
        ),
        sample_processor=lambda s: s["text"],
    ),
    "moral_instruct": DatasetConfig(
        path="./datasets/moral_instruct",
        loader=lambda path: load_dataset(
            "json", data_files=f"{path}/data.jsonl", split="train"
        ),
        sample_processor=lambda s: s["text"],
